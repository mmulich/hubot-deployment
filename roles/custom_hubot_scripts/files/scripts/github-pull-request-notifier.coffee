...
announcePullRequest = (data, cb) ->
  if data.action == 'opened'
    ...
    cb "Pull request \"#{data.pull_request.title}\" by #{data.pull_request.user.login} has been merged by #{data.pull_request.merged_by.login}: #{data.pull_request.html_url}"
